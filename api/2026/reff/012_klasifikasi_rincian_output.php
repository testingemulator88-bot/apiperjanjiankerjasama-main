...
if ($numcek > 0) {
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        $myArray = array();
        $sql = "select a.idnya as id,a.kdgiat as kdgiat,a.kdoutput as kode
        ,a.nmoutput as nama from toutput a where a.nmoutput<>'' " . $filter_query . "
        group by a.kdoutput,a.nmoutput order by a.kdoutput";
        //echo $sql;
        //die();
