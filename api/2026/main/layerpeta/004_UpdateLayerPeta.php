...
if ($numcek > 0) {
    ...
    $id = fixup($_POST['id']);
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($nama <> '') && ($id <> '') && ($level <> '')) {
        $sql = "update simfast_peta set nama='" . $nama . "'
        ,level='" . $level . "'
        ,urut='" . $urut . "',jenis='" . $jenis . "'
        ,asal_peta='" . $asal_peta . "',api='" . $api . "',filenya_peta=" . $filenya_peta . "
        ,tipe_peta='" . $tipe_peta . "',filenya_ikon=" . $filenya_ikon . "
        ,fill='" . $fill . "',stroke='" . $stroke . "',fill_width='" . $fill_width . "'
        ,stroke_width='" . $stroke_width . "',dash_start='" . $dash_start . "',dash_end='" . $dash_end . "'
        ,tipe_fill='" . $tipe_fill . "',tipe_pattern='" . $tipe_pattern . "'
        ,sudut='" . $sudut . "',urutindex='" . $urutindex . "'
        ,latitude='" . $latitude . "',longitude='" . $longitude . "',zoom='" . $zoom . "'
        ,radius='" . $radius . "',kolomfilter='" . $kolomfilter . "',textfilter='" . $textfilter . "'
        ,tampilpublik='" . $tampilpublik . "'
