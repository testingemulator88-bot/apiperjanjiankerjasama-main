...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($kode_satker_pejabat <> '')) {
        $sqlcekpejabat = "select id from tb_data_ttd_awal where deleted='0' and level_pejabat = '" . $level_pejabat . "' and kode_satker_pejabat = '" . $kode_satker_pejabat . "'";
        ...
        if ($numcekpejabat > 0) {
            ...
            $sql = " update tb_data_ttd_awal set level_pejabat='" . $level_pejabat . "'
            ...
            $sql = " insert into tb_data_ttd_awal (id, level_pejabat, kode_satker_pejabat, tanggal_pejabat
