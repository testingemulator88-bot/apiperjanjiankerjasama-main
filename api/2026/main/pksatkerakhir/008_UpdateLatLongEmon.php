...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id <> '')) {
        ...
        $sql = " update tb_data_pk_emon_akhir set " . $kolom . "='" . $isi . "'
        ...
        $sqlcekemon = "select id_pk,id_indikator,kode_satker,tahun from tb_data_pk_emon_akhir where id = '" . $id . "'";
        ...
        if ($numemon > 0) {
            ...
            $sqljumlah = "select sum(" . $kolom . ") as " . $kolom . " from tb_data_pk_emon_akhir where deleted = '0'
