...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id <> '')) {
        ...
        $sqlisian = " select nilai from  tb_data_pk_emon_akhir 
        where id = '" . $id . "'";
        ...
        $sqlku = " update tb_data_pk_emon_akhir set nilai='" . $kolomnya . "', rumus = '" . $rumusindikatorawal . "'
        ...
        $sqlcekemon = "select id_pk,id_indikator,kode_satker,tahun from tb_data_pk_emon_akhir where id = '" . $id . "' and tahun = '" . $tahundiubah . "'";
        //echo $sqlcekemon;
        //die;
        ...
        if ($numemon > 0) {
            ...
            $sqljumlah = "select nilai from tb_data_pk_emon_akhir where deleted = '0'
