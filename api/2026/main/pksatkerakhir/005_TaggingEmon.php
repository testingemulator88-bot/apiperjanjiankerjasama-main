...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id_indikator <> '') && ($kode_satker <> '')) {
        ...
        $sqlindikator = "select a.jumlahkomponen, a.kolomkomponen, a.bobotkomponen, a.rumuskomponen from tb_indikator_akhir a
        ...
        $sqlcekemon = "select * from tb_data_pk_emon_akhir where deleted ='0'
            ...
            if ($resultcekemon) {
                ...
                for ($x = 0; $x <= count($tempkode_emon) - 1; $x++) {
                    ...
                    if (!in_array($valueToSearch, $arrayemon)) {
                        ...
                        $sql = "insert into tb_data_pk_emon_akhir (id,id_pk,id_indikator,kode_tahun,tahun,kode_satker,kodekegiatanemon
                ...
                $sqlupdate = "delete from tb_data_pk_emon_akhir
                ...
                $sqlupdate = "update tb_data_pk_emon_akhir a set a.nmpaket = 
                (select b.nmpaket from paket_pk_akhir b where b.kode = a.kode_emon) WHERE a.nmpaket is null
