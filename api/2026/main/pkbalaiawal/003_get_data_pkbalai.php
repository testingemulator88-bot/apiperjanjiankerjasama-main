...
if ($numcek > 0) {
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        if ($id <> '') {
            ...
            $filterquerydeleted = $filterquerydeleted . " and id_indikator = '" . $id . "'";
        }
        if ($kdbalai <> '') {
            $filterquery = $filterquery . " and a.id_balai = '" . $kdbalai . "'";
            $filterquerydeleted = $filterquerydeleted . " and id_balai = '" . $kdbalai . "'";
        }
        if ($tahun <> '') {
            $filterquery = $filterquery . " and a.kode_tahun = '" . $tahun . "'";
            $filterquerydeleted = $filterquerydeleted . " and kode_tahun = '" . $tahun . "'";
        ...
        $sqldelete = "delete from tb_data_pk_balai_awal where deleted='0' " . $filterquerydeleted . " ";
                                                ...
                                                if ($hitungan_pkdetail == '1') {
                                                    ...
                                                    if ($numskortahunsekarang > 0) {
                                                        while ($rowskortahunsekarang = mysqli_fetch_assoc($resultskortahunsekarang)) {
                                                            if ($temprumuskolom1[$jumlahtambah] == 'IKSK7693SK101') {
                                                                $target_tahun_berjalan = (float) $rowskortahunsekarang['target'] * 1000000;
                                                            } else {
