...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($nama_komponen <> '') && ($bobot_komponen <> '') && ($id <> '')) {

        $sql = "UPDATE komponen SET kode_komponen = '" . $kode_komponen . "', nama_komponen = '" . $nama_komponen . "'
                    , bobot_komponen = '" . $bobot_komponen . "' WHERE id_komponen = '" . $id . "'";
        //echo $sql;
        //die;
