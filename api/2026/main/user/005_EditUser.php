...
if ($numcek > 0) {
    ...
    $usernametmp = fixup($_POST['usernamedatatmp']);
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id <> '') && ($nama <> '') && ($username <> '') && ($password <> '')) {
        if ($usernametmp <> $username) {
            ...
            if ($numcekuser > 0) {
                ...
                $sql = "update tb_user set nama='" . $nama . "',unor='" . $unor . "'
                ,jabatan='" . $jabatan . "',pangkat='" . $pangkat . "'
                ,nip='" . $nip . "',notelp='" . $notelp . "',alamat='" . $alamat . "'
                ,email='" . $email . "',level='" . $level . "',levelcode='" . $levelcode . "'
                ,levellabel='" . $levellabel . "',kategori_satker='" . $kategori_satker . "'
                ,username='" . $username . "',password='" . $password . "',satker='" . $satker . "'
                ,kode_satker='" . $kode_satker . "',verif='" . $verif . "',verifcode='" . $verifcode . "',veriflabel='" . $veriflabel . "'
                ,evaluasi='" . $evaluasi . "',evaluasicode='" . $evaluasicode . "',evaluasilabel='" . $evaluasilabel . "'
                ,verif2='" . $verif2 . "',verif2code='" . $verif2code . "',verif2label='" . $verif2label . "'
                ,verif3='" . $verif3 . "',verif3code='" . $verif3code . "',verif3label='" . $verif3label . "'
                ,hakaksesevaluatorlke = '". $satkerwewenangpusat ."',hakaksesevaluatorlkecode = '". $satkerwewenangpusatcode ."'
                ,hakaksesevaluatorlkelabel = '". $satkerwewenangpusatlabel ."'
                ,jenis_piu= '". $jenis_piu ."',token=md5('" . $username . "'),updatedate=SYSDATE(),updateby='" . $updatedby . "'
                where id = '" . $id . "'";
                // echo $sql;
                // die;
            ...
            $sql = "update tb_user set nama='" . $nama . "',unor='" . $unor . "'
                ...
                ,verif3='" . $verif3 . "',verif3code='" . $verif3code . "',verif3label='" . $verif3label . "'
                ,hakaksesevaluatorlke = '". $satkerwewenangpusat ."',hakaksesevaluatorlkecode = '". $satkerwewenangpusatcode ."'
                ,hakaksesevaluatorlkelabel = '". $satkerwewenangpusatlabel ."',jenis_piu= '". $jenis_piu ."',token=md5('" . $username . "'),updatedate=SYSDATE(),updateby='" . $updatedby . "'
                where id = '" . $id . "'";
            // echo $sql;
            // die;
            $result = mysqli_query($link, $sql);
