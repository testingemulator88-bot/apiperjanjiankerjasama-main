...
from tb_data_ttd_akhir where kode_satker_pejabat = '" . $kodebalai . "' and level_pejabat='Dirjen'";
//echo $sqlsatkerttd;
//die;
...
from tb_data_ttd_akhir where level_pejabat='Menteri'";
//echo $sqlbalaittd;
//die;
...
,ifnull((select sum(b.pg) from paket_pk_akhir b where b.kdprogram=a.kdprogram),0) as pagu
from tprogram a
