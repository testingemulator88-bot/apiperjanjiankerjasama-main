...
from tb_data_ttd where kode_satker_pejabat = '" . $kode_satker . "' and level_pejabat='Satker'";
//echo $sqlsatkerttd;
//die;
...
from tb_data_ttd where kode_satker_pejabat = '" . $kdbalai . "' and level_pejabat='Balai'";
//echo $sqlbalaittd;
//die;
...
if (((float) $levelpiu == 6)) {
	$sqlbalaittd = "select nama_pejabat, jabatan_pejabat, filenya_ttd
	from tb_data_ttd where kode_satker_pejabat='03694117'";
	//echo $sqlbalaittd;
	//die;
	$resultbalaittd = mysqli_query($link, $sqlbalaittd);
	while ($rowbalaittd = mysqli_fetch_assoc($resultbalaittd)) {
...
if (((float) $levelpiu == 31)) {
	$sqlbalaittd = "select nama_pejabat, jabatan_pejabat, filenya_ttd
	from tb_data_ttd where level_pejabat='DirSupan'";
	//echo $sqlbalaittd;
	//die;
	$resultbalaittd = mysqli_query($link, $sqlbalaittd);
	while ($rowbalaittd = mysqli_fetch_assoc($resultbalaittd)) {
...
if (((float) $levelpiu == 9)) {
	$sqlbalaittd = "select nama_pejabat, jabatan_pejabat, filenya_ttd
	from tb_data_ttd where level_pejabat='DirSSPSDA'";
	//echo $sqlbalaittd;
	//die;
	$resultbalaittd = mysqli_query($link, $sqlbalaittd);
	while ($rowbalaittd = mysqli_fetch_assoc($resultbalaittd)) {
