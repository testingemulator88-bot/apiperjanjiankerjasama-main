...
from tb_data_ttd where kode_satker_pejabat = '" . $kodebalai . "' and level_pejabat='Balai'";
//echo $sqlsatkerttd;
//die;
...
from tb_data_ttd where level_pejabat='Dirjen'";
//echo $sqlbalaittd;
//die;
...
,ifnull((select sum(b.pg) from paket_pk b where b.kdprogram=a.kdprogram
