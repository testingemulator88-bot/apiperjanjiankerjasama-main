...
$sqlsatker = "select GROUP_CONCAT(kode_satker) as  kode_satker, GROUP_CONCAT(kode_satker_pendek) as  kode_satker_pendek
from master_satker where deleted='0'";
//echo $sqlsatkeremon;
//die;
...
from tb_data_ttd where kode_satker_pejabat = '" . $kodebalai . "' and level_pejabat='Dirjen'";
//echo $sqlsatkerttd;
//die;
...
from tb_data_ttd where level_pejabat='Menteri'";
//echo $sqlbalaittd;
//die;
...
where a.kode_pelaksana = '" . $kodebalaipendek . "' and a.deleted='0' and a.id_pelaksana in (32,45)
...
<tr>
<td align="center" width="1000px">	
<b>KEMENTERIAN PEKERJAAN UMUM REPUBLIK INDONESIA</b>
</td>
</tr>
</table>
';
...
,(select count(zz.id) from tb_data_pk_tidak_cetak zz where zz.id_indikator=a.id and zz.deleted='0'
								...
								if (!$found) {
									...
									if ($rowlevelPROGRAM['hitungan_pk'] == '1') {
										...
										for ($x = $tahun_awal; $x <= $tahunsekarang; $x++) {
											...
											from tb_data_pk_balai a where a.deleted='0' and a.tahun='" . $x . "' 
														...
														if ($rowlevelPROGRAM['hitungan_pk'] == '1') {
															...
															if (strstr($rumuskolom1, "IKSK")) {
																...
																for ($jumlahtambah = 0; $jumlahtambah < count($temprumuskolom1); $jumlahtambah++) {
																	$sqlcekhitungan = "select id,hitungan_pk from tb_indikator where deleted = '0'
																	...
																	if ($hitungan_pkdetail == '1') {
																		...
																		and id_indikator = (select id from tb_indikator where deleted='0' and kode_unique = '" . $temprumuskolom1[$jumlahtambah] . "')
																		and tahun = '" . $x . "'";
															...
															if (strstr($rumuskolom2, "IKSK")) {
																...
																for ($jumlahtambah = 0; $jumlahtambah < count($temprumuskolom2); $jumlahtambah++) {
																	...
																	if ($hitungan_pkdetail == '1') {
																		...
																		and kdbalai = '" . $kodebalai . "') 
																		and kode_tahun='" . $tahun . "'
																		and id_indikator = (select id from tb_indikator where deleted='0' and kode_unique = '" . $temprumuskolom2[$jumlahtambah] . "')
																		and tahun = '" . $x . "'";
																		//echo $sqlskortahunsekarang;
																		$resultskortahunsekarang = mysqli_query($link, $sqlskortahunsekarang);
																		$numskortahunsekarang = mysqli_num_rows($resultskortahunsekarang);
															...
															if (strstr($rumuskolom3, "IKSK")) {
																...
																for ($jumlahtambah = 0; $jumlahtambah < count($temprumuskolom3); $jumlahtambah++) {
																	...
																	if ($hitungan_pkdetail == '1') {
																		...
																		and kdbalai = '" . $kodebalai . "') 
																		and kode_tahun='" . $tahun . "'
																		and id_indikator = (select id from tb_indikator where deleted='0' and kode_unique = '" . $temprumuskolom3[$jumlahtambah] . "')
																		and tahun = '" . $x . "'";
																		//echo $sqlskortahunsekarang;
																		$resultskortahunsekarang = mysqli_query($link, $sqlskortahunsekarang);
																		$numskortahunsekarang = mysqli_num_rows($resultskortahunsekarang);
															...
															if (strstr($rumuskolom4, "IKSK")) {
																...
																for ($jumlahtambah = 0; $jumlahtambah < count($temprumuskolom4); $jumlahtambah++) {
																	...
																	if ($hitungan_pkdetail == '1') {
																		...
																		and kdbalai = '" . $kodebalai . "') 
																		and kode_tahun='" . $tahun . "'
																		and id_indikator = (select id from tb_indikator where deleted='0' and kode_unique = '" . $temprumuskolom4[$jumlahtambah] . "')
																		and tahun = '" . $x . "'";
																		//echo $sqlskortahunsekarang;
																		$resultskortahunsekarang = mysqli_query($link, $sqlskortahunsekarang);
																		$numskortahunsekarang = mysqli_num_rows($resultskortahunsekarang);
															...
															if (strstr($rumuskolom5, "IKSK")) {
																...
																for ($jumlahtambah = 0; $jumlahtambah < count($temprumuskolom5); $jumlahtambah++) {
																	...
																	if ($hitungan_pkdetail == '1') {
																		...
																		and kdbalai = '" . $kodebalai . "') 
																		and kode_tahun='" . $tahun . "'
																		and id_indikator = (select id from tb_indikator where deleted='0' and kode_unique = '" . $temprumuskolom5[$jumlahtambah] . "')
																		and tahun = '" . $x . "'";
																		//echo $sqlskortahunsekarang;
																		$resultskortahunsekarang = mysqli_query($link, $sqlskortahunsekarang);
																		$numskortahunsekarang = mysqli_num_rows($resultskortahunsekarang);
...
,ifnull((select sum(b.pg) from paket_pk b where b.kdprogram=a.kdprogram),0) as pagu
from tprogram a
	...
	if ($resultPROGRAMLAMPIRAN2) {
		while ($rowPROGRAMLAMPIRAN2 = mysqli_fetch_assoc($resultPROGRAMLAMPIRAN2)) {
			...
			while ($rowKEGIATANLAMPIRAN2 = mysqli_fetch_assoc($resultKEGIATANLAMPIRAN2)) {
				...
				and a.id in (select b.id_parent from tb_indikator b where b.deleted = '0' 
				and b.id in ((select c.id_indikator from tb_data_pk c where b.deleted='0' and c.kode_satker in (" . $groupkode_satker . "))))
				order by a.id_parent ASC,a.urutlevel ASC, a.urut ASC ";
				...
				while ($rowSKLAMPIRAN2 = mysqli_fetch_assoc($resultSKLAMPIRAN2)) {
					...
					$sqlcektampilmaster = "select pelaksana from tb_indikator where deleted='0' and id_parent = '" . $rowSKLAMPIRAN2['id'] . "'";
					$resultcektampilmaster = mysqli_query($link, $sqlcektampilmaster);
					$numcektampilmaster = mysqli_num_rows($resultcektampilmaster);


					$sqlcektampil = "select id from tb_data_pk_tidak_cetak where deleted='0' and id_indikator in 
					(select id from tb_indikator where deleted='0' and id_parent = '" . $rowSKLAMPIRAN2['id'] . "')
					...
					////
					$sqlcektampilINDIKATOR = "select pelaksana from tb_indikator where deleted='0' and id_parent = '" . $rowSKLAMPIRAN2['id'] . "' ";
					...
					and a.pelaksana <> ''
					and a.id in (select b.id_indikator from tb_data_pk b where b.deleted='0' and b.kode_satker in (" . $groupkode_satker . "))
					order by a.id_parent ASC,a.urutlevel ASC, a.urut ASC ";
					...
					while ($rowIKSKLAMPIRAN2 = mysqli_fetch_assoc($resultIKSKLAMPIRAN2)) {
						...
						if ($rowIKSKLAMPIRAN2['hitungan_pk'] == '2' || $rowIKSKLAMPIRAN2['hitungan_pk'] == '3') {
							...
							if ($rowIKSKLAMPIRAN2['kode_unique'] == 'IKSK7755SK113') {
								...
								if (($rowIKSKLAMPIRAN2['kode_unique'] == 'IKSK7688SK110') || ($rowIKSKLAMPIRAN2['kode_unique'] == 'IKSK7688SK111')
									...
									|| ($rowIKSKLAMPIRAN2['kode_unique'] == 'IKSK7755SK112')
									|| ($rowIKSKLAMPIRAN2['kode_unique'] == 'IKSK7755SK114')
								) {
						...
						$sqlcektampilIKSK = "select id from tb_data_pk_tidak_cetak where deleted='0' and id_indikator = '" . $rowIKSKLAMPIRAN2['id'] . "'
						and kode_satker in (" . $groupkode_satker . ")";
						$resultcektampilIKSK = mysqli_query($link, $sqlcektampilIKSK);
						$numcektampilIKSK = mysqli_num_rows($resultcektampilIKSK);

						$sqlcektampilINDIKATOR = "select pelaksana from tb_indikator where deleted='0' and id = '" . $rowIKSKLAMPIRAN2['id'] . "' ";
						//echo $sqlcektampilINDIKATOR."<br>";
						$resultcektampilINDIKATOR = mysqli_query($link, $sqlcektampilINDIKATOR);
						$numcektampilINDIKATOR = mysqli_num_rows($resultcektampilINDIKATOR);
						$jumlahcek = 0;
