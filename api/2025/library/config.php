...
error_reporting(0);
$dbhost = "localhost";
$dbuser = "pars9694_4dm1n";
$dbpass = "j2a098002";
$dbname = "pars9694_monika_2025";
$link = new mysqli($dbhost, $dbuser, $dbpass, $dbname) or die("Connect failed: %s\n" . $conn->error);

$db = "pars9694_monika_2025";
$dbbackup = "pars9694_dbemon";
$judul = "API";
$webRoot = "https://monika.sisda.net/2025/";
...
{
	$link = mysqli_connect("localhost", "pars9694_4dm1n", "j2a098002", "pars9694_monika_2025");
	$nama = "";
