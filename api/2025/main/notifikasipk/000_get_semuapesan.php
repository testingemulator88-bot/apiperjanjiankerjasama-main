...
if ($numcek > 0) {
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        if ($level == '7' || $level == '8' || $level == '4') {
            ...
            , a.verifikasi_ke ,'hasil verifikasi' as mode, a.id_pelaksana, a.kode_pelaksana,a.jenis_pk,a.readed
            ...
            if ($jenis_piusistem == '34') {
                ...
                , a.verifikasi_ke ,'pengajuan verifikasi' as mode, a.id_pelaksana, a.kode_pelaksana,a.jenis_pk,a.readed
