...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($kdunor <> '') && ($tahun <> '')) {
        if ($mode == 'Tambah') {
            $sql = "insert into tb_indikator_awal (id,tahun,id_parent,kdunor,urutlevel,level,kode,kode_unique,nama,satuan
            ...
            ,jumlahkomponen,kolomkomponen,bobotkomponen,rumuskomponen
            ...
            ,'" . $isian_kolom . "','" . $jumlahkomponen . "','" . $kolomkomponen . "','" . $bobotkomponen . "','" . $rumuskomponen . "'
            ,SYSDATE(),'" . $createdby . "','0')";
        } else {
            $sql = "update tb_indikator_awal set tahun = '" . $tahun . "',kdunor = '" . $kdunor . "',nama = '" . $nama . "'
            ...
            ,bobotkomponen= '" . $bobotkomponen . "',rumuskomponen= '" . $rumuskomponen . "',updatedate = SYSDATE(), updateby='" . $createdby . "'
            where id = '" . $id . "'";
        ...
        $sql = "update tb_indikator_awal set id_parent = null where id_parent ='0'";
        $result = mysqli_query($link, $sql);
        if ($result) {
            mysqli_close($link);
