...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id_indikator <> '')) {
        ...
        $sqlcek = "select id from tb_data_baseline_awal where deleted='0' and kode_tahun='" . $kode_tahun . "'
        ...
        if ($numcek == 0) {
            if ($hitungan_pk == '1') {
                $sql = "insert into tb_data_baseline_awal (id,kode_tahun,id_indikator,id_satker,kode_satker,baseline
            ...
            if ($hitungan_pk == '2' || $hitungan_pk == '3') {
                $sql = "insert into tb_data_baseline_awal (id,kode_tahun,id_indikator,id_satker,kode_satker,baseline_komponen_a
            ...
            if ($hitungan_pk == '1') {
                $sql = "update tb_data_baseline_awal set baseline='" . $baseline . "', updateby='" . $createdby . "'
            ...
            if ($hitungan_pk == '2' || $hitungan_pk == '3') {
                $sql = "update tb_data_baseline_awal set nilai='" . $baseline . "'
                , updateby='" . $createdby . "'
                ,updatedate=SYSDATE() where kode_tahun='" . $kode_tahun . "' and deleted='0'
                and id_satker='" . $id_satker . "' and kode_satker='" . $kode_satker . "' and id_indikator = '" . $id_indikator . "'";
                //echo $sql;
        ...
        if ($hitungan_pk == '1') {
            ...
            for ($x = $tahun_awal; $x <= $tahun_akhir; $x++) {
                $sqlcek2 = "select id from tb_data_pk_awal where deleted='0' and kode_tahun='" . $kode_tahun . "' and tahun='" . $x . "'
                ...
                if ($numcek2 == 0) {
                    $sql = "insert into tb_data_pk_awal (id,id_indikator,kode_tahun,tahun,id_satker,kode_satker
                    ,proyek,volume,target
                    ,createddate,createdby,deleted) values 
                    ...
                    $sql = "update tb_data_pk_awal set proyek='" . $tempproyek[$z] . "'
        ...
        if ($hitungan_pk == '2' || $hitungan_pk == '3') {
            ...
            //$sqlrumus = "";
            $sqlrumus = "update tb_data_pk_awal set deleted='1' where kode_tahun='" . $kode_tahun . "' and id_satker='" . $id_satker . "' and deleted='0'
            and kode_satker='" . $kode_satker . "' and tahun = '" . $x . "' and id_indikator = '" . $id_indikator . "'";
            //echo $sql . "<br>";
            //die;
            ...
            for ($x = $tahun_awal; $x <= $tahun_akhir; $x++) {
                $sqlcek2 = "select id,rumus from tb_data_pk_awal where deleted='0' and kode_tahun='" . $kode_tahun . "' and tahun='" . $x . "'
                and id_indikator='" . $id_indikator . "' and id_satker='" . $id_satker . "' and kode_satker='" . $kode_satker . "'
                and deleted='0'";
                $resultcek2 = mysqli_query($link, $sqlcek2);
                $numcek2 = mysqli_num_rows($resultcek2);
