...
if ($numcek > 0) {
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        if ($cari <> '') {
            $filterquery = $filterquery." and a.nama_kategori like '%" . $cari . "%'";
        }
        ...
        $myArray = array();
        $sql = "select a.id,a.kdbalai,a.kdbalai_old,a.nama_kategori as nama,a.alamat
        ,a.latitude,a.longitude from master_unor a where a.deleted='0' 
        " . $filterquery . "
        order by a.id 
        limit " . $mulai . " , 20 ";
        //echo $sql;
