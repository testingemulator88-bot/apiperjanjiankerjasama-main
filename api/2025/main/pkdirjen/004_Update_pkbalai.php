...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id_indikator <> '') && ($id_balai <> '') && ($kode_tahun <> '')) {
        ...
        $sqlindikator = "select * from tb_indikator where deleted='0' and id='" . $id_indikator . "' ";
        //echo $sqlindikator;
        //die;
        ...
        $sqlcek = "select id from tb_data_baseline_pk_balai where deleted='0' and kode_tahun='" . $kode_tahun . "'
        ...
        if ($numcek == 0) {
            $sql = "insert into tb_data_baseline_pk_balai (id,kode_tahun,id_indikator,id_balai,kode_balai,kolom1,kolom2,kolom3,kolom4
            ...
            $sql = "update tb_data_baseline_pk_balai set kolom1='" . $baselinekolom1 . "',kolom2='" . $baselinekolom2 . "'
        ...
        for ($x = $tahun_awal; $x <= $tahun_akhir; $x++) {
            ...
            if ($hitungan_pk_awal == '2' || $hitungan_pk_awal == '3') {
                ...
                $sqlupdatedata = "update tb_data_pk_balai set nilai = '" . $nilaifinal . "', rumus = '" . $masterrumus . "'
