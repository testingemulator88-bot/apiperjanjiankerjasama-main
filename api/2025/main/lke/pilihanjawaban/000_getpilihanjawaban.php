...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        $sql    = "SELECT a.id_jawaban, a.pilihan_jawaban, a.nilai, a.penjelasan_jawaban, a.kategori_jawaban 
                    FROM pilihan_jawaban as a
                    WHERE a.is_active='1' ORDER BY a.id_jawaban, a.pilihan_jawaban ASC";
