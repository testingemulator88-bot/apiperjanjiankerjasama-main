...
if ($numcek > 0) {
    ...
    $rekomendasi            = fixup($_POST['rekomendasi']);
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($rekomendasi <> '') && ($tanggapan_evaluator <> '') && ($tindak_lanjut <> '') && ($id_lke <> '')) {
        ...
        $sql = "UPDATE hasil_lke SET kriteria_penilaian1 = '" . $kriteria_penilaian1 . "', kriteria_penilaian2 = '" . $kriteria_penilaian2 . "', kriteria_penilaian3 = '" . $kriteria_penilaian3 . "', 
                kriteria_penilaian4 = '" . $kriteria_penilaian4 . "', tanggapan_evaluator = '" . $tanggapan_evaluator . "', deskripsi_rekomendasi = '" . $rekomendasi . "', status_tindak_lanjut = '" . $tindak_lanjut . "', status_lke='4' 
