...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '')) {
        ...
        if($id_user != '' && $tahun != ''){
            ...
            $sql_evaluator  = "SELECT a.tim, a.nip, a.jabatan, c.nama_kategori FROM evaluator as a
            ...
            $sql_evaluatan_row = "SELECT nip, tim, jabatan, tahun FROM evaluatan WHERE kode_satker = '". $id_user ."' AND tahun = '". $tahun ."' AND level in (7) AND is_active = '1' ORDER BY id_evaluatan ASC LIMIT 1";
            ...
            if(strstr($level, '1') || strstr($level, '5') || strstr($level, '6')){
            ...
            $sql_evaluatan_rows     = "SELECT tim FROM evaluatan WHERE kode_satker = '". $id_user ."' AND tahun = '". $tahun ."' AND level in (7) AND is_active = '1' ORDER BY id_evaluatan ASC";
                ...
                if ($KomponenResult2) {
                    while ($rowKomponen2 = mysqli_fetch_assoc($KomponenResult2)) {
                        ...
                        $subKomponenSql2    = "SELECT d.deskripsi_rekomendasi, d.status_tindak_lanjut from subkomponen as b 
                                                ...
                                                where d.tahun = '". $tahun ."' and d.kode_satker = '". $id_user ."' AND d.level in (7) and b.is_active = 1 and b.id_komponen = '". $rowKomponen2['id_komponen'] ."'";
                        ...
                        while($rowSubKomponen2 = mysqli_fetch_assoc($subKomponenResult2)){
                            $subKomponenArray2[] = (object)[
                                ...
                                'tindak_lanjut' => html_entity_decode($rowSubKomponen2['status_tindak_lanjut']),
                            ];
                        }
