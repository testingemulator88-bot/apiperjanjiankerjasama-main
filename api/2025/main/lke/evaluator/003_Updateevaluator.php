...
if ($numcek > 0) {
    ...
    if (($Bearer <> '') && ($tempBearer[1] <> '') && ($id_user <> '') && ($tahun_evaluasi <> '') && ($id <> '')) {

        $sql = "UPDATE evaluator SET tim = '" . $tim . "', nip = '" . $nip . "', jabatan = '" . $jabatan . "', tahun_evaluasi = '" . $tahun_evaluasi . "' WHERE id_evaluator = '" . $id . "'";
        //echo $sql;
        //die;
